...
import g3_2.open_channel.ChannelCardRecyclerViewAdapter;
import g3_2.open_channel.ChannelGridItemDecoration;
import g3_2.open_channel.HomeFragment;
import g3_2.open_channel.NavigationHost;
import g3_2.open_channel.ProfileFragment;
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.allChannels:
                    ((NavigationHost) getActivity()).navigateTo(new ChannelBaseFragment(), false);
                    return true;
                case R.id.account:
