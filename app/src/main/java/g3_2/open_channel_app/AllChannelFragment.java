...
public class AllChannelFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        RecyclerView recyclerView = view.findViewById(R.id.all_channel_recycler_view);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new GridLayoutManager(getContext(), 1, GridLayoutManager.VERTICAL, false));
        CardChannelAdapter adapter = new CardChannelAdapter(
                getContext(),ChannelEntry.initProductEntryList(getResources(),R.raw.channels), AllChannelFragment.this);
